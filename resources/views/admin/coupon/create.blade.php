...
@section('meta_title', 'Add New Coupon')
@section('content')
                    ...
                    <form action="{{ route('admin.coupon.store') }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="text" class="form-control" name="coupon_code" value="{{ old('coupon_code') }}" placeholder="Enter Coupon Code">
                            </div>
                            <div class="form-group">
                                @error('coupon_type')
                                ...
                                <select class="form-control" name="coupon_type" id="">
                                    ...
                                    <option value="single" @selected(old('coupon_type')=='single')>Single</option>
                                    <option value="multiple" @selected(old('coupon_type')=='multiple')>Multiple</option>
                                </select>
                            </div>
                            <div class="form-group">
                                @error('discount_type')
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="number" class="form-control" name="minimum_booking_value" value="{{ old('minimum_booking_value') }}"placeholder="Enter Minimum Booking Value">
                            </div>
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="number" class="form-control" name="maximum_discount_value" value="{{ old('maximum_discount_value') }}"placeholder="Enter Maximum Discount Value">
                            </div>
                            <div class="form-group">
                                @error('start_date')
                                ...
                                @enderror
                                <input type="date" class="form-control" name="start_date" value="{{ old('start_date') }}"placeholder="Choose Start Date">
                            </div>
                            <div class="form-group">
                                @error('expiry_date')
                                ...
                                @enderror
                                <input type="date" class="form-control" name="expiry_date" value="{{ old('expiry_date') }}"placeholder="Choose Expiry Date">
                            </div>
                            <div class="form-group">
                                @error('info')
                                ...
                                class="form-control" rows="3" name="info"
                                    placeholder="Enter Description ...">{{ old('info') }}</textarea>
                            </div>
                            <div class="form-group">
                                @error('thumbnail')
