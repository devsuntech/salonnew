                    ...
                    <form action="{{ route('admin.package.update', $data->id) }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="text" class="form-control" name="name" value="{{ old('name') ?? $data->name  }}"placeholder="Enter Service Name">
                            </div>
                            <div class="form-group">
                                @error('price')
                                ...
                                @enderror
                                <input type="number" class="form-control" name="price" value="{{ old('price') ?? $data->price }}" placeholder="Enter Price">
                            </div>
                            <div class="form-group">
                                @error('validity')
                                ...
                                @enderror
                                <input type="number" class="form-control" name="validity" value="{{ old('validity') ?? $data->validity }}" placeholder="Enter Validity (In Days)">
                            </div>
                            <div class="form-group">
                                @error('position')
                                ...
                                @enderror
                                <input type="number" class="form-control" name="position" value="{{ old('position') ?? $data->position }}" placeholder="Enter Position">
                            </div>
                            <div class="form-group">
                                @error('description')
