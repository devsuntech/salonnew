                    ...
                    <form action="{{ route('admin.service.update', $data->id) }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="category">
                                    ...
                                    @foreach (App\Models\Category::orderBy('name')->get() as $cat )
                                         <option value="{{ $cat->id }}" @if($data->category_id ?? old('category')==$cat->id) selected @endif>{{ $cat->name }}</option>
                                    @endforeach
                                </select>
                              </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('meta_description') ??  $data->meta_title }}"
                            ...
                            <div class="form-group">
                                <img src="{{ asset('storage/'.$data->icon) }}" alt="{{  $data->name }}" width="80"/>
                            </div>
                            <div class="form-group">
                                @error('icon')
