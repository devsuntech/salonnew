...
@section('meta_title','Edit Vendor')
@section('content')
<section class="content">
    <div class="container-fluid">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('admin.vendor.update',$data->id) }}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control" name="name" value="{{ old('name')?? $data->name }}"placeholder="Enter Vendor Name">
                        </div>
                        <div class="form-group">
                            @error('firm_name')
                            ...
                            <input type="text" class="form-control" name="firm_name"  value="{{ old('firm_name')?? $data->firm_name }}" placeholder="Enter Firm Name">
                        </div>
                        <div class="form-group">
                            @error('state')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="amenities[]" multiple>
                                ...
                                @foreach (App\Models\Amenity::orderBy('name')->get() as $amenity )
                                     <option value="{{ $amenity->id }}" @if(in_array($amenity->id,json_decode($data->amenities))) selected @endif>{{ $amenity->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            class="form-control" rows="3" name="firm_address"
                                placeholder="Enter Firm Address ...">{{ old('firm_address') ?? $data->firm_address }}</textarea>
                        </div>
                        <div class="form-group">
                            @error('about_firm')
                            ...
                            class="form-control" rows="3" name="about_firm"
                                placeholder="Enter Details About Firm ...">{{ old('about_firm') ?? $data->about_firm}}</textarea>
                        </div>
                        <div class="form-group">
                            @error('email')
                        ...
                        <div class="form-group">
                            <img src="{{ asset('storage/'.$data->gst_file) }}" alt="{{  $data->name }}" width="80"/>
                        </div>
                        <div class="form-group">
                            @error('gst_file')
                        ...
                        <div class="form-group row">
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="paymentMethod1" @if((old('paymentMethod') && in_array('Gpay',old('paymentMethod'))) || (in_array('Gpay',json_decode($data->payment_methods)))) checked @endif name="paymentMethod[]" value="Gpay">
                            ...
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="paymentMethod2" @if((old('paymentMethod') && in_array('UPI',old('paymentMethod'))) || (in_array('UPI',json_decode($data->payment_methods))))  checked @endif name="paymentMethod[]" value="UPI">
                            ...
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="paymentMethod3" @if((old('paymentMethod') && in_array('Paytm',old('paymentMethod'))) || (in_array('Paytm',json_decode($data->payment_methods))))checked @endif name="paymentMethod[]" value="Paytm">
                            ...
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="paymentMethod4"  @if((old('paymentMethod') && in_array('Cards',old('paymentMethod'))) || (in_array('Cards',json_decode($data->payment_methods)))) checked @endif name="paymentMethod[]" value="Cards">
                        ...
                        <div class="form-group row">
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="amenities1" @if((old('amenities') && in_array('Washroom',old('amenities'))) || (in_array('Washroom',json_decode($data->amenities)))) checked @endif name="amenities[]" value="Washroom">
                            ...
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="amenities2" @if((old('amenities') && in_array('Parking',old('amenities'))) || (in_array('Parking',json_decode($data->amenities))))  checked @endif name="amenities[]" value="Parking">
                            ...
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="amenities3" @if((old('amenities') && in_array('Pet Friendly',old('amenities'))) || (in_array('Pet Friendly',json_decode($data->amenities))))checked @endif name="amenities[]" value="Pet Friendly">
                            ...
                            <div class="form-group  col-md-3 col-6 clearfix">
                                <div class="icheck-primary d-inline">
                                  <input type="checkbox" id="amenities4"  @if((old('amenities') && in_array('Home Appointment',old('amenities'))) || (in_array('Home Appointment',json_decode($data->amenities)))) checked @endif name="amenities[]" value="Home Appointment">
                        ...
                        <div class="form-group">
                            <img src="{{ asset('storage/'.$data->feature_image) }}" alt="{{  $data->name }}" width="80"/>
                        </div>
                        ...
                        <div class="form-group">
                            <img src="{{ asset('storage/'.$data->thumbnail) }}" alt="{{  $data->name }}" width="80"/>
                        </div>
                        <div class="form-group">
                            @error('thumbnail')
