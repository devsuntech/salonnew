                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td valign="top" style="text-align: center; padding: 10px 20px 15px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #fff;">
                                                <p style="margin: 0;">
                                                    <a href="#"></a>You have booked a session at The Peace of mind spa,check out the details below.</p>
                                            </td>
                                        </tr>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="message">
                        <tr>
                            <td style="padding: 40px 40px 20px 40px; text-align: center;">
                                <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 26px; color: #333333; font-weight: bold;">Thank you for choosing us!</h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <p>We look forward to welcoming you to The peace of Mind Spa.<br /> Our professional and friendly staff are committed to ensuring your session is both relaxing and comfortable. Should you have any requests prior for your
                                    session, please do not hesitate to contact us and we will endeavor to assist you whenever possible. Thanks & Best Regards, Shelly, The Laguna Sunrise Resort team</p>
                                <p style="margin: 0;font-weight: bold;">Deep Tissue Massage with oil head massage - 2h - ₹550</p>
                            </td>
                        </tr>
                        <tr>
