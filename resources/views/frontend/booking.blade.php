...
<head>
    ...
    <style>
        ...
        .book__select_time_date_box.next_button, .book__select_time_date_box.prev_button {
            align-self: center;
            border:none;
            opacity: .5;
            cursor: not-allowed;
...
<body style="background-color: #f2f2f7;">
                                ...
                                <label for="razorpay">
                                    <div class="list-sec row">
                                        <div class="col-lg-9 service-name">
                                            ...
                                            <div>
                                                <h4>Pay Online</h4>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 32" class="paymentgateways Icon-sc-c98r68-0 dSuruW styled__CardIcon-sc-17tfpv0-2 kMurAP">
                                        <rect width="45" height="32" fill="#FFF" rx="4"></rect>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 32" class="paymentgateways Icon-sc-c98r68-0 dSuruW styled__CardIcon-sc-17tfpv0-2 kMurAP">
                                            <rect width="45" height="32" fill="#FFF" rx="4"></rect>
                                            <g transform="translate(11 9)" fill-rule="nonzero">
                                                ...
                                                <ellipse cx="7.077" cy="7" fill="#E61C24" rx="7.077" ry="7"></ellipse>
                                                <ellipse cx="15.865" cy="7" fill="#F99F1B" rx="7.077" ry="7"></ellipse>
                                            </g>
                                        </svg><svg width="142" height="141" viewBox="0 0 142 141" fill="none" xmlns="http://www.w3.org/2000/svg" class=" paymentgateways Icon-sc-c98r68-0 dSuruW styled__CardIcon-sc-17tfpv0-2 kMurAP">
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="white"></path>
                                            <defs>
                                                <radialGradient id="paint0_radial_6:14620" cx="0" cy="0" r="1"
                                        ...
                                        <svg width="29" height="19" viewBox="0 0 29 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="paymentgateways Icon-sc-c98r68-0 dSuruW styled__CardIcon-sc-17tfpv0-2 kMurAP">
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#0374B8"></path>
                                        </svg><svg width="42" height="8" viewBox="0 0 42 8" fill="none" xmlns="http://www.w3.org/2000/svg" class=" paymentgateways Icon-sc-c98r68-0 dSuruW styled__CardIcon-sc-17tfpv0-2 kMurAP">
                                            <path
    ...
    <script>
            ...
            let createRazorpayBooking = (bookingData) => {
                ...
                .done(function( data ) {
                    const options = {
                        ...
                        "order_id": data.online_payment_method_ref_id, //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
        ...
        $('body').on('click', '.book__select_time_date_box.next_button.enabled, .book__select_time_date_box.prev_button.enabled', function () {
            let dateBoxItems = '';
