...
@section('meta_title','User Login')
@section('meta_description','User Login')
@section('content')
                    ...
                    <div class="sign__wrapper white-bg">
                        <div class="sign__header mb-35">
                            <div class="sign__in sign-breadcrumb-inner">
                                <a href="login/facebook" class="sign__social text-start mb-15"><i class="fab fa-facebook-f"></i>Sign in with Facebook</a>
                                <a href="login/google" class="bg-goggle sign__social text-start mb-15 "><i class="fab fa-google"></i>Sign in with Google</a>
                        ...
                        <div class="sign__form">
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="sign__new text-center mt-20">
                                    <p>New to Salon N me? <a href="{{ route('register') }}">Sign Up</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
