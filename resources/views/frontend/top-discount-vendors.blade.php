                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="top-heading">
                            <h3>Found 30+ Results for Salon in Mumbai</h3>
                        </div>
                                        ...
                                        <div class="row custom-row pb-10">
                                            ...
                                            <div class="col-xl-4 col-md-6 custom-col">
                                                <div class="featured-wrap-3 mb-30 style-2 mb-30">
                                                    ...
                                                    <div class="thumb">
                                                        <img src="{{ asset('storage/'.$vendor->feature_image) }}" alt="thumb">
                                                    ...
                                                    <div class="content content-update">
                                                        ...
                                                        <div class="author-info author-info-2">
                                                            <div class="text">
                                                                <h5>
                                                                    <a href="{{ route('vendor.detail',$vendor->slug) }}">{{ $vendor->frim_name }} <i class="fal fa-check-circle"></i></a>
                                                                </h5>
