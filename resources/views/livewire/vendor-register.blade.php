<div class="sign__form">
    ...
    <div class="col-lg-12 form-step {{ $currentStep != 1 ? '' : 'form-step-active' }} ">
        <div class="row ">
            ...
            <div class="col-lg-12 sign__input-wrapper mb-10 ">
                <h5>Full Address :</h5>
                <div class="sign__input ">
                    <input type="text" wire:model="full_address" id="pac-input" autocomplete="off"
                        placeholder="Full Address ">
                    <a href="#" id="current-location" onClick="currentLocation()"><i
                            class="fal fa-location "></i></a>
                </div>
                @error('full_address')
                    <label class="messages text-danger">{{ $message }}</label>
                @enderror
    ...
    <div class="col-lg-12 form-step {{ $currentStep != 2 ? '' : 'form-step-active' }}">
        <div class="row ">
            ...
            <div class="col-lg-6 sign__input-wrapper mb-10 ">
                ...
                <div class="sign__input ">
                    <input type="file" wire:model="featured_image" placeholder="Image"
            ...
            <div class="col-lg-12 sign__input-wrapper mb-10 ">
                ...
                <div class="checkbox-sec">
                    ...
                    <label class="container">UPI
                        <input type="checkbox" wire:model="payment_method" id="paymentMethod2" checked="checked"
                            value="UPI">
            ...
            <div class="btns-group row ">
                ...
                <button class="m-btn m-btn-4 w-100 btn-next btn" type="button" wire:click="secondStepSubmit">
                    <span></span>Next</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 form-step {{ $currentStep != 3 ? '' : 'form-step-active' }}">
        <div class="row ">
            <div class="col-lg-12 sign__input-wrapper mb-25 ">
                <h5>Services for :</h5>
                <div class="sign__input ">
            ...
            <div class="col-lg-12 sign__input-wrapper mb-10 ">
                ...
                {{-- <div class="sign__input "> --}}
                    ...
                    @foreach (App\Models\Category::orderBy('name')->get()->chunk(4) as $category)
                    {{-- {{dd($category)}} --}}
                    <div class="checkbox-sec" style="margin-bottom:10px">
                        @foreach ($category as $values)
                            
                                <label class="container"> {{ $values->name }}
                                    <input type="checkbox" wire:model="service_type" value="{{ $values->id }}">
                    ...
                    if (results[1]) {
                        ...
                        for (var i = 0; i < results[0].address_components.length; i++) {
                            for (var b = 0; b < results[0].address_components[i].types.length; b++) {
                                ...
                                if (typeof results[1].address_components[i] !== 'undefined' && results[1]
                                    .address_components[i].types[b] == "locality") {
                                    //this is the object you are looking for
